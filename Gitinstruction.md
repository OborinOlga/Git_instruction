...
Принято в отслеживание добавлять только текстовые файла, а большые файлы, например, картинки нет. А в удаленных репозиториях вместо файлов принято использовать ссылки (относительные) .
Значит в папку изначально копируем файл-картинку, потом в папке создаем файл ` .gitignore `.

Открыть созданный файл и записать в него название файла-картинки с расширением или шаблоны к \тим файлам или папкам.

Все файлы записанные и `.gitignore` игнорируются. Изменился цвет файла-картинки на серый.
После этого обязательно записать коммит
## 15. Работа с изображениями в Git
