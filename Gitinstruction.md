...
```
## ***16. Изменение имени текущей ветки***
...
## ***19. Слияние веток с конфликтами***
...
```
Команда ` git clone ` автоматически настраивает репозиторий, в котором значение remote будет соответствовать URL-адресу Git, из которого был клонирован репозиторий.
...
```
## ***22. Извлечение содержимого из удалённого репозитория (безопасный вариант)***
...
```
## ***23. Извлечение содержимого из удалённого репозитория (принудительный вариант)***
...
## ***24. Создание бесплатного удалённого репозитория на GitHub и помещение конфигурации в него***
...
```
## ***25. Отправка изменений на сервер/удалённый репозиторий по умолчанию***
...
## ***26. Принудительная отправка изменений на сервер/удалённый репозиторий при исправлении коммитов***
...
```
## ***27. Просмотр подключений к удалённым репозиториям***
...
git remote -v
```
## ***28. Переименование удалённого репозитория***
...
```
## ***29. Удаление подключения к удалённому репозиторию***
...
```
## ***30. Стирание локальной и удаленной ветки***
