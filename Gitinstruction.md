...
Открываем созданный файл и записываем в него название файла-картинки с расширением или шаблоны к этих файлов.

Все файлы записанные и `.gitignore` автоматически игнорируются. Цвет игнорируемых файлов-картинок - серый.
