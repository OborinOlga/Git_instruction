...
## ***3.8. Создание бесплатного удалённого репозитория на GitHub и помещение конфигурации в него***
...
## ***3.10. Принудительная отправка изменений на сервер/удалённый репозиторий при испо=равлении коммитов***
